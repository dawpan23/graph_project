...
For it to work: You need to create a .txt file called "graph.txt" in the same folder as the executable file. Example file (and a working version of this program) is available in the releases section.
